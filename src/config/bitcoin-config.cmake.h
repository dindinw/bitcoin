/* src/config/bitcoin-config.h.  Generated from bitcoin-config.cmake.h.in by CMake.  */
/* bitcoin-config.cmake.h.in modified from  bitcoin-config.h.in */
/* bitcoin-config.h.in Generated from configure.ac by autoheader.  */
